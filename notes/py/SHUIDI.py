...
class Spider(Spider):
    ...
    def gethost(self):
        ...
        response = self.fetch('https://gh.jasonzeng.dev/https://raw.githubusercontent.com/leilingzero/muji/master/notes/py/ext/shudi.txt',headers=headers).text
#       response = self.fetch('https://cnb.cool/xiaomideyun/xiaomideyun/-/git/raw/main/shudi.txt',headers=headers).text
        return response.strip()

    def aes(self, text, b=None):
        key = b"gKdQKLbwhhLp4Ytv"
